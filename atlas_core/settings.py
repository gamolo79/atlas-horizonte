...
SINTESIS_CLUSTER_LABEL_LIMIT = int(
    os.environ.get("SINTESIS_CLUSTER_LABEL_LIMIT", "8")
)
SINTESIS_SECTION_STORY_LIMIT = int(
    os.environ.get("SINTESIS_SECTION_STORY_LIMIT", "6")
)

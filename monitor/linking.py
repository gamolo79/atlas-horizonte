...
def link_mentions(
    ...
    for mention in mentions:
        ...
        # Evita procesar el mismo surface repetido dentro del mismo artículo (reduce ruido y costo IA)
        key = (mention.article_id, (mention.surface or "").strip().lower())
        if key in seen_surface_by_article:
            continue
